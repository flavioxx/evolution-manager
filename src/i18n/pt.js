...
export default {
  ...
  about: {
    title: "Sobre",
    description: "O Manager facilita a gestão de suas APIs com uma interface intuitiva. Ele foi criado por desenvolvedores independentes, focando em melhorar a experiência do usuário e a administração das funcionalidades da API.",
    contribute: "",
    dataProcess: {
      ...
      https: "Por conta de todo o processamento ser realizado no navegador, é necessário que o servidor da API seja acessado através de uma conexão segura (HTTPS)."
    },
    version: "Versão",
  },
  contribute: {
