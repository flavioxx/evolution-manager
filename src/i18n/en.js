...
export default {
  ...
  about: {
    title: "About",
    description: "Manager makes it easy to manage your APIs with an intuitive interface. It was created by independent developers, focusing on improving the user experience and administration of API functionalities.",
    contribute: "",
    dataProcess: {
      ...
      https: "Due to all processing being done in the browser, it is necessary to access the API server through a secure connection (HTTPS)."
    },
    version: "Version",
  },
  contribute: {
